...
type DbgateSpec struct {
	...
	// Foo is an example field of Dbgate. Edit dbgate_types.go to remove/update
...
type Dbgate struct {
	...
	Status DbgateStatus `json:"status,omitempty"`
}
...
type DbgateList struct {
	...
	Items           []Dbgate `json:"items"`
}

func init() {
	SchemeBuilder.Register(&Dbgate{}, &DbgateList{})
}
