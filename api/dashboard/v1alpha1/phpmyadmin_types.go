...
type PhpmyadminSpec struct {
	...
	// Foo is an example field of Phpmyadmin. Edit phpmyadmin_types.go to remove/update
...
type Phpmyadmin struct {
	...
	Status PhpmyadminStatus `json:"status,omitempty"`
}
...
type PhpmyadminList struct {
	...
	Items           []Phpmyadmin `json:"items"`
}

func init() {
	SchemeBuilder.Register(&Phpmyadmin{}, &PhpmyadminList{})
}
